...
const FILM_THEMES = [
    ...
    { key: 'titanic', name: 'Титаник',            re: /(titanic|титаник)/,                                        accent: '#5B8DEF', accent2: '#D9C08A', bg: '#050A14', fx: 'ocean' },
    // ── фэнтези и сериалы ───────────────────────────────────
...
const FilmTheme = {
    ...
    // сопоставление кэшируется: 69 регулярок на каждую перелистнутую карточку ни к чему
    match: (m) => {
