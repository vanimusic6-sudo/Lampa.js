...
const FILM_THEMES = [
    ...
    { key: 'spider',  name: 'Человек-паук',       re: /(spider ?man|человек ?паук|паучок|spider verse)/,          accent: '#BC0B26', accent2: '#02119F', bg: '#0A0A14', fx: 'spider' },
    { key: 'shrek',   name: 'Шрэк',               re: /(shrek|шрэк|шрек)/,                                        accent: '#D1D646', accent2: '#88796B', bg: '#121608', fx: 'none' },
...
/* тема под фильм: уши Шрэка по углам карточки */
.cm-f-shrek .cm-port:before,.cm-f-shrek .cm-port:after{content:"";position:absolute;top:-1.05em;width:1.9em;height:1.1em;
background:var(--cm-accent2);border-radius:1.2em 1.2em 0 0;opacity:.9;box-shadow:inset 0 -.22em .3em rgba(0,0,0,.28)}
.cm-f-shrek .cm-port:before{left:1.6em;transform:rotate(-12deg)}
.cm-f-shrek .cm-port:after{right:1.6em;transform:rotate(12deg)}
